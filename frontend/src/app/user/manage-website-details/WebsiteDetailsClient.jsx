...
const WebsiteDetailsClient = () => {
    ...
    const fetchWebsiteData = async () => {
      try {
        ...
        const websiteRes = await axios.get(
          `${backendUrl}/api/websites/${websiteId}`,
          {
        ...
        const bugsRes = await axios.get(
          `${backendUrl}/api/bugs/by-website/${websiteId}`,
          {
            headers: { Authorization: `Bearer ${storedToken}` },
          }
        );
  ...
  const getPluginScript = () => {
    ...
    const backendUrl = "https://bughead.onrender.com"; // Consider using environment variables for this
    return `<link rel="stylesheet" href="https://bughead.onrender.com/index.css" />
  <script>
...
<script type="module" src="${backendUrl}/index.js"></script>`;
  };
  ...
  const handleDeleteWebsite = async () => {
    try {
      const backendUrl = "https://bughead.onrender.com"; // Consider using environment variables for this
      await axios.delete(`${backendUrl}/api/websites/${websiteId}`, {
        headers: { Authorization: `Bearer ${storedToken}` },
      });
...
export default WebsiteDetailsClient;